...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".vsurf/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".vsurf/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.vsurf/agent/sessions)
