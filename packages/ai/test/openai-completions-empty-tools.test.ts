...
// Regression for https://github.com/earendil-works/vsurf-mono/issues/<issue-number>
...
describe("openai-completions empty tools handling", () => {
	...
	it("uses OpenAI reasoning fields for an explicitly configured private VSurf Inference route", async () => {
