...
function resolveCacheRetention(cacheRetention?: CacheRetention): CacheRetention {
	...
	if (typeof process !== "undefined" && process.env.VSURF_CACHE_RETENTION === "long") {
		return "long";
	}
	return "short";
}
...
function createClient(
	...
	if (model.provider === "vsurf-inference") {
...
function parseChunkUsage(
	...
	// Normalize to vsurf-ai semantics:
...
function detectCompat(model: Model<"openai-completions">): ResolvedOpenAICompletionsCompat {
	...
	const isPrimeInference = provider === "vsurf-inference" || baseUrl.includes("api.pinference.ai");
