...
<h1 align="center">VSurf Core</h1>

<p align="center">
  Stateful agent runtime.
</p>

Release docs use the VSurf package names. The source workspace manifests still keep inherited package names until the namespace migration is complete.

## Workspace Package

```bash
npm install vsurf-core
```

## Quick Start

```typescript
import { Agent } from "vsurf-core";
...
```typescript
import { Agent, streamProxy } from "vsurf-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "vsurf-core";
