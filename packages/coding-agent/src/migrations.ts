...
const MIGRATION_GUIDE_URL =
	"https://github.com/earendil-works/vsurf-mono/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/earendil-works/vsurf-mono/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.vsurf/agent/*.jsonl to the session root.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.vsurf/agent/ instead of
 * ~/.vsurf/agent/sessions/. This migration moves them to the configured
 * session root.
 *
 * See: https://github.com/earendil-works/vsurf-mono/issues/320
 */
 ...
 *
 * Older versions stored sessions under ~/.vsurf/agent/sessions/--cwd--/*.jsonl.
 ...
 * Note: tools/ may contain fd/rg binaries extracted by vsurf, so only warn if it has other files.
 */
