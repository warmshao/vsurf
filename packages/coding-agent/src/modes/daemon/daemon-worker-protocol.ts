...
export const DAEMON_WORKER_ROLE_ENV = "VSURF_INTERNAL_DAEMON_WORKER";
export const DAEMON_WORKER_TOKEN_ENV = "VSURF_INTERNAL_DAEMON_WORKER_TOKEN";
export const DAEMON_WORKER_ACTIVE_SESSION_ID_ENV = "VSURF_INTERNAL_DAEMON_WORKER_ACTIVE_SESSION_ID";
export const DAEMON_WORKER_SUPERVISOR_SOCKET_ENV = "VSURF_INTERNAL_DAEMON_SUPERVISOR_SOCKET";
export const DAEMON_WORKER_RECOVERY_JOURNAL_ENV = "VSURF_INTERNAL_DAEMON_WORKER_RECOVERY_JOURNAL";
export const DAEMON_WORKER_STARTUP_GATE_FD_ENV = "VSURF_INTERNAL_DAEMON_WORKER_STARTUP_GATE_FD";
