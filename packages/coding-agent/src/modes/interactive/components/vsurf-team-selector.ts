import { Container, type Focusable, fuzzyFilter, getKeybindings, Spacer, TruncatedText } from "vsurf-tui";
import type { PrimeTeam } from "../../../core/vsurf-inference-auth.js";
...
export class PrimeTeamSelectorComponent extends Container implements Focusable {
	...
	constructor(
		...
		const panel = new MenuPanel({
			title: "Prime Team",
			subtitle: "Choose which account pays for VSurf Inference usage.",
		});
		this.addChild(panel);
