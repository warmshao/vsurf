...
export const FEATURE_HINTS: readonly FeatureHintDefinition[] = [
	...
	{
		id: "subagents",
		getText: () => "VSurf can delegate tasks to subagents and run them in parallel.",
	},
	{
		id: "agents-view",
	...
	{
		id: "auto-compaction",
		getText: () => "VSurf automatically compacts long sessions before context fills up.",
	},
	{
		id: "auto-refine",
		getText: () => "VSurf self-improves by refining skills, memories, prompts, and subagents.",
	},
	{
