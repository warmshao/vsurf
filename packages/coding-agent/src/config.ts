...
export const SELF_UPDATE_INTERACTIVE_CHILD_ENV = "VSURF_INTERACTIVE_SELF_UPDATE";
...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/warmshao/vsurf/releases/latest`;
	}
	if (method === "homebrew") {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.VSURF_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json vsurfConfig)
// =============================================================================
...
const vsurfConfigName: string | undefined = pkg.vsurfConfig?.name;
const envPrefix =
	(vsurfConfigName || "vsurf")
		.toUpperCase()
		.replace(/[^A-Z0-9]+/g, "_")
		.replace(/^_+|_+$/g, "") || "PI";
export const PACKAGE_NAME: string = pkg.name || "vsurf";
export const APP_NAME: string = vsurfConfigName || "vsurf";
export const APP_TITLE: string = vsurfConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.vsurfConfig?.configDir || ".vsurf/agent";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., VSURF_CODING_AGENT_DIR or VSURF_CODING_AGENT_DIR
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.VSURF_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.vsurf/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.vsurf/agent/) */
...
/** Directory where daemon and client diagnostic logs are written (e.g. ~/.vsurf/agent/logs/). */
