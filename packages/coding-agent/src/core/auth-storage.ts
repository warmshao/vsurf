 ...
 *
 * Uses file locking to prevent race conditions when multiple vsurf instances
...
export class AuthStorage {
	 ...
	 * Multiple vsurf instances may try to refresh simultaneously when tokens expire.
	 */
