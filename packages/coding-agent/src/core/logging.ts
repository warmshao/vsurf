import { type LogEntry, setLogSink, stringifyLogEntry } from "vsurf-ai";
...
/**
 * Route all structured logging (coding-agent and vsurf-ai) to the shared JSONL
 * log at ~/.vsurf/agent/logs/agent.jsonl. One master file, filterable by the
