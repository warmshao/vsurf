...
import type { AssistantMessage, ImageContent, Message, ServiceTier, TextContent, Usage } from "vsurf-ai";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if vsurf-generated (backward compatible) */
	fromHook?: boolean;
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if vsurf-generated */
	fromHook?: boolean;
}
