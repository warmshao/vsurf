...
import { Agent, type AgentMessage, type ThinkingLevel } from "vsurf-agent";
import { clampThinkingLevel, type Message, type Model, streamSimple, supportsFastMode } from "vsurf-ai";
...
export interface CreateAgentSessionOptions extends AgentSessionCreationOptions {
	...
	cwd?: string;
	/** Global config directory. Default: ~/.vsurf/agent */
	agentDir?: string;
	 ...
	 *
	 * When omitted, vsurf enables the default built-in tool (ipython)
