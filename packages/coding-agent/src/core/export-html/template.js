    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="vsurf-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="vsurf-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'vsurf-share:v1:sidebar-width';
