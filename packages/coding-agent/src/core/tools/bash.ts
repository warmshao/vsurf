...
import { Container, Text, truncateToWidth } from "vsurf-tui";
...
/**
 * Create bash operations using vsurf's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want vsurf's
...
export function createBashToolDefinition(
	...
	const definition: ToolDefinition<typeof bashSchema, BashToolDetails | undefined, BashRenderState> = {
		...
		async execute(
			...
			const output = new OutputAccumulator({ tempFilePrefix: "vsurf-bash" });
