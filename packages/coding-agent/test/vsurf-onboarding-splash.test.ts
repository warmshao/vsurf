...
import { setKeybindings, visibleWidth } from "vsurf-tui";
import { KeybindingsManager } from "../src/core/keybindings.js";
import { PrimeOnboardingSplashComponent } from "../src/modes/interactive/components/vsurf-onboarding-splash.js";
...
describe("PrimeOnboardingSplashComponent", () => {
	...
	it("renders a minimal first-run login action", () => {
		...
		expect(output).not.toContain("vsurf");
