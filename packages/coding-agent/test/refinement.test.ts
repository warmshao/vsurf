...
import type * as PiAi from "vsurf-ai";
import type { AssistantMessage, Model } from "vsurf-ai";
import {
...
vi.mock("vsurf-ai", async (importOriginal) => {
...
function makeTempDir(): string {
	tempDir = mkdtempSync(join(tmpdir(), "vsurf-refinement-test-"));
	return tempDir;
}
