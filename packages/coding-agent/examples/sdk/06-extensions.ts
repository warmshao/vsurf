...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "vsurf";
...
export default function (vsurf: ExtensionAPI) {
	...
	vsurf.on("agent_end", async (event) => {
	...
	// Register a command
	vsurf.registerCommand("mycommand", {
