...
Programmatic usage of the VSurf SDK via `createAgentSession()` and `createAgentSessionRuntime()`.

The published TypeScript packages still use inherited `@earendil-works/vsurf-*`
...
| `agentDir` | `~/.vsurf/agent` | Config directory |
