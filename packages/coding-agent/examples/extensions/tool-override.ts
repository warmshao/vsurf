 ...
 * - Routing tool calls to remote systems (e.g., vsurf-ssh-remote)
...
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "vsurf";
import type { TextContent } from "vsurf-ai";
...
export default function (vsurf: ExtensionAPI) {
	...
	vsurf.registerCommand("file-reader-log", {
