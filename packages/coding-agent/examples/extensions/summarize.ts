import type { ExtensionAPI, ExtensionCommandContext } from "vsurf";
import { DynamicBorder, getMarkdownTheme } from "vsurf";
import { complete, getModel } from "vsurf-ai";
import { Container, Markdown, matchesKey, Text } from "vsurf-tui";
...
export default function (vsurf: ExtensionAPI) {
	vsurf.registerCommand("summarize", {
