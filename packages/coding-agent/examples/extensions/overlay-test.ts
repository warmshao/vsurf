 ...
 *
 * Usage: vsurf --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "vsurf-tui";

export default function (vsurf: ExtensionAPI) {
	vsurf.registerCommand("overlay-test", {
