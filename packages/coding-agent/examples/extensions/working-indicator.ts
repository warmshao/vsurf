 ...
 * working indicator shown while vsurf is streaming a response.
 *
 * Usage:
 *   vsurf --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore vsurf's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "vsurf";
...
export default function (vsurf: ExtensionAPI) {
	...
	vsurf.registerCommand("working-indicator", {
