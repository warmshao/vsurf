 ...
 * (logo + keybinding hints) with a custom component showing the vsurf mascot.
 */

import type { ExtensionAPI, Theme } from "vsurf";
import { VERSION } from "vsurf";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the vsurf agent character
...
export default function (vsurf: ExtensionAPI) {
	...
	vsurf.registerCommand("builtin-header", {
