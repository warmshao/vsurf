...
Play DOOM as an overlay in vsurf. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
vsurf --extension ./examples/extensions/doom-overlay
```
...
- [vsurf-doom](https://github.com/badlogic/vsurf-doom) for the original vsurf integration
