 ...
 * Commands Extension
 *
 * Demonstrates the vsurf.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "vsurf";

export default function commandsExtension(vsurf: ExtensionAPI) {
	vsurf.registerCommand("commands", {
