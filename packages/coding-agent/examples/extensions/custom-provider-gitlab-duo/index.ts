 ...
 * Delegates to vsurf-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   vsurf -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (vsurf: ExtensionAPI) {
	vsurf.registerProvider("gitlab-duo", {
