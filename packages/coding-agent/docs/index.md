...
VSurf is an RLM-native coding and research harness built around a persistent IPython kernel, recursive subagents, durable sessions, and a multi-process local runtime. It began as a hard fork of vsurf-mono, but VSurf is now the product, CLI, install source, and development repository.
...
Public releases are installed from npm. The internal workspace package names in the source tree are implementation details, not the public install path.

## Start Here

- [Quickstart](quickstart.md) - install, authenticate, and run a first session.
- [Using VSurf](usage.md) - interactive mode, RLM subagents, slash commands, context files, and CLI reference.
...
- [Skills](skills.md) - markdown and Python-backed skills, including how to ask VSurf to create them.
...
- [VSurf packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
- [Custom models](models.md) - add model entries for supported provider APIs.
- [Custom providers](custom-provider.md) - implement custom APIs and OAuth flows.

## Programmatic Usage

- [SDK](sdk.md) - embed VSurf in Node.js applications.
- [ACP mode](acp.md) - drive VSurf from any Agent Client Protocol client.
