> VSurf can create prompt templates. Ask it to build one for your workflow.
...
VSurf loads prompt templates from:

- Global: `~/.vsurf/agent/prompts/*.md`
- Project: `.vsurf/agent/prompts/*.md`
- Packages: `prompts/` directories or `vsurf.prompts` entries in `package.json`
