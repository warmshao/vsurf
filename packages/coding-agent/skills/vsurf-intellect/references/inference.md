...
VSurf Inference is an OpenAI-compatible API for frontier and open models, routed across providers and built for large-scale evaluations.
...
```bash
export VSURF_API_KEY="your-api-key-here"
```
...
prime eval run gsm8k -m meta-llama/llama-3.1-70b-instruct -n 25   # evals route through VSurf Inference
```

Eval runs against VSurf Inference models report estimated USD cost automatically.
...
client = openai.OpenAI(
    api_key=os.environ["VSURF_API_KEY"],
